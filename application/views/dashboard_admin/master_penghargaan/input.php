...
<div class="x_panel"><div class="x_content">
	...
	<?php } ?>
		<?php echo form_open('master_penghargaan/simpan',''); ?>
		  <div class="mb-3">
		  	<legend>Master Penghargaan</legend>
			<label class="form-label fw-semibold" for="nama_penghargaan">Nama Penghargaan</label>
			<div>
			  <input type="text" class="form-control" name="nama_penghargaan" id="nama_penghargaan" value="<?php echo $nama_penghargaan; ?>" placeholder="Nama Penghargaan">
			</div>
		  </div>
