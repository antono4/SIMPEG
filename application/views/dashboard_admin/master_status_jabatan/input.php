...
<div class="x_panel"><div class="x_content">
	...
	<?php } ?>
		<?php echo form_open('master_status_jabatan/simpan',''); ?>
		  <div class="mb-3">
		  	<legend>Master Status Jabatan</legend>
			<label class="form-label fw-semibold" for="nama_jabatan">Nama Status Jabatan</label>
			<div>
			  <input type="text" class="form-control" name="nama_jabatan" id="nama_jabatan" value="<?php echo $nama_jabatan; ?>" placeholder="Nama Status Jabatan">
			</div>
		  </div>
