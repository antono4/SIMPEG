<?php $this->load->view('dashboard_admin/layout/main_header', array('page_title' => 'Detail Pegawai', 'active_menu' => '')); ?>
  ...
  <div class="x_panel">
    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div class="mb-3 row"><div class="col-md-3"><strong>NIP</strong></div>
		  ...
		  <div class="mb-3 row"><div class="col-md-3"><strong>NIP Lama</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="nip_lama" id="nip_lama" value="<?php echo $nip_lama; ?>" placeholder="NIP Lama">
			</div>
		  </div>
		  <div class="mb-3 row"><div class="col-md-3"><strong>Nomor Kartu Pegawai</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="no_kartu_pegawai" id="no_kartu_pegawai" value="<?php echo $no_kartu_pegawai; ?>" placeholder="Nomor Kartu Pegawai">
			</div>
		  </div>
		  <div class="mb-3 row"><div class="col-md-3"><strong>Nama Pegawai</strong></div>
		  ...
		  <div class="mb-3 row"><div class="col-md-3"><strong>Tempat Lahir</strong></div>
		  ...
		  <div class="mb-3 row"><div class="col-md-3"><strong>Nomor NPWP</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="no_npwp" id="no_npwp" value="<?php echo $no_npwp; ?>" placeholder="Nomor NPWP">
			</div>
		  </div>
		  <div class="mb-3 row"><div class="col-md-3"><strong>Kartu Askes Pegawai</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="kartu_askes_pegawai" id="kartu_askes_pegawai" value="<?php echo $kartu_askes_pegawai; ?>" placeholder="Kartu Askes Pegawai">
			</div>
		  </div>
		  <div class="mb-3 row"><div class="col-md-3"><strong>Tanggal Lahir</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="tanggal_lahir" id="tanggal_lahir" value="<?php echo $tanggal_lahir; ?>" placeholder="Tanggal Lahir">
			</div>
		  </div>
		  <div class="mb-3 row"><div class="col-md-3"><strong>Jenis Kelamin</strong></div>
		  ...
		  <div class="mb-3 row"><div class="col-md-3"><strong>Agama</strong></div>
		  ...
		  <div class="mb-3 row"><div class="col-md-3"><strong>Usia</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="usia" id="usia" value="<?php echo $usia; ?>" placeholder="Usia">
			</div>
		  </div>
		  <div class="mb-3 row"><div class="col-md-3"><strong>Status Pegawai</strong></div>
		  ...
		  <div class="mb-3 row"><div class="col-md-3"><strong>Tanggal Pengangkatan CPNS</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="tanggal_pengangkatan_cpns" id="tanggal_pengangkatan_cpns" value="<?php echo $tanggal_pengangkatan_cpns; ?>" placeholder=
			  "Tanggal Pengangkatan CPNS">
			</div>
		  </div>
		  <div class="mb-3 row"><div class="col-md-3"><strong>Alamat</strong></div>
			
			<div class="col-md-6">
				<textarea disabled="disabled" class="form-control" style="outline:none; resize:none;" name="alamat" id="alamat" placeholder=
        ...
        <div class="tab-pane fade" id="dtpangkat">
          ...
          <div class="mb-3 row"><div class="col-md-3"><strong>Golongan</strong></div>
          ...
          <div class="mb-3 row"><div class="col-md-3"><strong>Nomor SK</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="nomor_sk_pangkat" id="nomor_sk_pangkat" value="<?php echo $nomor_sk_pangkat; ?>" placeholder=
			  "Nomor SK Pangkat">
			</div>
		  </div>
          <div class="mb-3 row"><div class="col-md-3"><strong>Tanggal SK</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="tanggal_sk_pangkat" id="tanggal_sk_pangkat" value="<?php echo $tanggal_sk_pangkat; ?>" placeholder=
			  "Tanggal SK Pangkat">
			</div>
		  </div>
          <div class="mb-3 row"><div class="col-md-3"><strong>Tanggal Mulai</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="tanggal_mulai_pangkat" id="tanggal_mulai_pangkat" value="<?php echo $tanggal_mulai_pangkat; ?>" placeholder=
			  "Tanggal Mulai Pangkat">
			</div>
		  </div>
          <div class="mb-3 row"><div class="col-md-3"><strong>Tanggal Selesai</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="tanggal_selesai_pangkat" id="tanggal_selesai_pangkat" value="<?php echo $tanggal_selesai_pangkat; ?>" placeholder=
        ...
        <div class="tab-pane fade" id="dtjabatan">
          ...
          <div class="mb-3 row"><div class="col-md-3"><strong>Status Jabatan</strong></div>
          ...
          <div class="mb-3 row"><div class="col-md-3"><strong>Jabatan</strong></div>
          ...
          <div class="mb-3 row"><div class="col-md-3"><strong>Unit Kerja</strong></div>
          ...
          <div class="mb-3 row"><div class="col-md-3"><strong>Satuan Kerja</strong></div>
          ...
          <div class="mb-3 row"><div class="col-md-3"><strong>Lokasi Kerja</strong></div>
          ...
          <div class="mb-3 row"><div class="col-md-3"><strong>Nomor SK</strong></div>
			...
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="nomor_sk_jabatan" id="nomor_sk_jabatan" value="<?php echo $nomor_sk_jabatan; ?>" placeholder=
			  "Nomor SK Jabatan">
			</div>
		  </div>
          <div class="mb-3 row"><div class="col-md-3"><strong>Tanggal SK</strong></div>
			...
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="tanggal_sk_jabatan" id="tanggal_sk_jabatan" value="<?php echo $tanggal_sk_jabatan; ?>" placeholder=
			  "Tanggal SK Jabatan">
			</div>
		  </div>
          <div class="mb-3 row"><div class="col-md-3"><strong>Tanggal Mulai</strong></div>
			...
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="tanggal_mulai_jabatan" id="tanggal_mulai_jabatan" value="<?php echo $tanggal_mulai_jabatan; ?>" placeholder=
          ...
          <div class="mb-3 row"><div class="col-md-3"><strong>Tanggal Selesai</strong></div>
			...
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="tanggal_selesai_jabatan" id="tanggal_selesai_jabatan" value="<?php echo $tanggal_selesai_jabatan; ?>" placeholder=
			  "Tanggal Selesai Jabatan">
			</div>
		  </div>
          <div class="mb-3 row"><div class="col-md-3"><strong>Eselon</strong></div>
          ...
          <div class="mb-3 row"><div class="col-md-3"><strong>TMT Eselon</strong></div>
			
			<div class="col-md-6">
			  <input type="text" disabled="disabled" class="form-control" name="tmt_eselon" id="tmt_eselon" value="<?php echo $tmt_eselon; ?>" placeholder=
			  "TMT Eselon">
			</div>
		  </div>
        </div>
	<div class="tab-pane fade" id="dtfoto">
			...
			?>
          <div class="mb-3">
			<label class="form-label fw-semibold" for="nip">Foto Pegawai</label>
			<div>
