  ...
  <div class="card card-body mb-3">
	<div class="navbar navbar-expand-lg navbar-dark bg-primary toolbar-navbar px-3 py-2"><div class="container-fluid">
		<div class="d-flex flex-wrap align-items-center gap-3 w-100">
		  <a class="navbar-brand mb-0 fs-6 fw-bold" href="#">Laporan Pegawai - Urut Kepangkatan</a>
		...
		?>
			...
			<select class="form-select form-select-sm w-auto" name="id_gol_awal">
			...
			s/d
			<select class="form-select form-select-sm w-auto" name="id_gol_akhir">
			<option value="">- Golongan -</option>
			  	<?php
			  		foreach($mst_golongan->result_array() as $msk)
			  		{
		...
		<div class="span4 float-end">
  		<a class="btn btn-secondary" href="<?php echo base_url(); ?>laporan_pegawai_urut_kepangkatan/export"><i class="bi bi-check-circle"></i> Export ke Excell</a>
