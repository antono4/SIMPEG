  ...
  <div class="x_panel">
	<div class="toolbar-navbar"><div class="container-fluid">
		<div class="d-flex flex-wrap align-items-center gap-3 w-100">
		  <a class="toolbar-brand" href="#">Laporan Pegawai - Unit Kerja & Satuan Kerja</a>
		...
		?>
			...
			<div class="col-md-3">
			 <select class="form-control input-sm w-auto" name="id_unit_kerja">
		...
		<a class="btn btn-default" href="<?php echo base_url(); ?>laporan_pegawai_unit_satuan/export"><i class="fa fa-check-circle"></i> Export ke Excell</a>
