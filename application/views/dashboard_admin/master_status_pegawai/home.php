  ...
  <div class="x_panel">
	<div class="toolbar-navbar"><div class="container-fluid">
		<div class="d-flex flex-wrap align-items-center gap-3 w-100">
		  <a class="toolbar-brand" href="#">Master Status Pegawai</a>
		  <div class="toolbar-group">
			<ul class="list-inline toolbar-list">
			  <li><a class="btn btn-default btn-sm iframe-box-sm" href="<?php echo base_url(); ?>master_status_pegawai/tambah"><i class="fa fa-plus-circle "></i> Tambah Status Pegawai</a></li>
			</ul>
		  </div>
  ...
  <table class="table table-hover table-condensed ">
	...
	?>
      <tr>
		...
		<td>
	        <div class="btn-group">
	          <a class="btn btn-sm btn-default iframe-box-sm" href="<?php echo base_url(); ?>master_status_pegawai/detail/<?php echo $dp['id_status_pegawai']; ?>"><i class="fa fa-check-circle"></i> Lihat Detail</a>
	          <a class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a class="dropdown-item iframe-box-sm" href="<?php echo base_url(); ?>master_status_pegawai/edit/<?php echo $dp['id_status_pegawai']; ?>"><i class="fa fa-pencil"></i> Edit Data</a></li>
	            <li><a class="dropdown-item" href="<?php echo base_url(); ?>master_status_pegawai/hapus/<?php echo $dp['id_status_pegawai']; ?>" onClick="return confirm('Anda yakin..???');"><i class="fa fa-trash"></i> Hapus Data</a></li>
	          </ul>
	        </div><!-- /btn-group -->
		</td>
      </tr>
